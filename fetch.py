#!/usr/bin/env python3
"""
Recupero codici sconto vidaXL da shopilo.it
Sursa: https://shopilo.it/negozi/vidaxl.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/vidaxl.it"
STORE_NAME = "vidaXL"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per vidaXL da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-vidaxl)"
    }
    try:
